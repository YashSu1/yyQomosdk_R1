...
BOOL CQClick::AllowLogin(long lSerialNO, LPCTSTR pStudentID, BOOL bIsAllowLogin, BOOL bIsSendStudentName, LPCTSTR pStudentName)
{
	BOOL result;
	static BYTE parms[] =
		VTS_I4 VTS_BSTR VTS_BOOL VTS_BOOL VTS_BSTR;
	InvokeHelper(0x8, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms,
		lSerialNO, pStudentID, bIsAllowLogin, bIsSendStudentName, pStudentName);
	return result;
}
...
long CQClick::HomeworkSetExamTitle(short nExamID, LPCTSTR pExamTitle, short nQuestionNum, BOOL bRandomPaper)
{
	long result;
	static BYTE parms[] =
		VTS_I2 VTS_BSTR VTS_I2 VTS_BOOL;
	InvokeHelper(0xb, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		nExamID, pExamTitle, nQuestionNum, bRandomPaper);
	return result;
}
...
long CQClick::StartSessionRF500(LPCTSTR pClassName, LPCTSTR pTeacherName, long lMaxStudents, short nSessionType, BOOL bLoginFlag, BOOL bAutoLoginFlag, short nReanswerTimes)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR VTS_I4 VTS_I2 VTS_BOOL VTS_BOOL VTS_I2;
	InvokeHelper(0xf, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		pClassName, pTeacherName, lMaxStudents, nSessionType, bLoginFlag, bAutoLoginFlag, nReanswerTimes);
	return result;
}

long CQClick::StartTestKeypad()
{
	long result;
